...
#Stores
Store.create(name: "South Waterfront", street: "672 S Gaines St #2", city: "Portland", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "503-245-7000", lat: 45.4962086, lng: -122.6711421)

Store.create(name: "Pearl", street: "1405 NW Johnson St", city: "Portland", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "971-360-5000", lat: 45.5290032, lng: -122.6855771)

Store.create(name: "LADD's Addition", street: "1954 SE Division St", city: "Portland", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "503-244-9000", lat: 45.5043279, lng: -122.6460567)

Store.create(name: "Multnomah", street: "7850 SW Capital Hwy", city: "Portland", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "503-245-8000", lat: 45.4676428, lng: -122.7137918)

Store.create(name: "LO", street: "401 A Ave", city: "Lake Oswego", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "971-246-3000", lat: 45.4208182, lng: -122.6683848)

Store.create(name: "Beaverton", street: "11425 SW Beaverton", city: "Beaverton", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "971-244-4000", lat: 45.487567, lng: -122.794757)

Store.create(name: "Lents", street: "4040 SE 82nd Ave", city: "Portland", state: "Oregon", open: "9:00 AM", close: "11:00 PM", phone: "971-650-6000", lat: 45.493328, lng: -122.5745717)
